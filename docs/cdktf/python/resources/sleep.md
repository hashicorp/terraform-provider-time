...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_db_subnet_group_example = DbSubnetGroup(self, "example_2",
            ...
            subnet_ids=[
                Token.as_string(
                    property_access(ram_resource_propagation.triggers, ["\"subnet_id\""]))
            ]
        )
...
<!-- cache-key: cdktf-0.17.1 input-73a2d0d8f07a92177ff8e69d3b8b07c852fc6f16cd4c3f99105c5d12d1cda96c -->