		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "rfc822", offsetTimestamp.Format(time.RFC822)),
					resource.TestCheckResourceAttr(resourceName, "rfc822z", offsetTimestamp.Format(time.RFC822Z)),
					resource.TestCheckResourceAttr(resourceName, "rfc850", offsetTimestamp.Format(time.RFC850)),
					resource.TestCheckResourceAttr(resourceName, "rfc1123", offsetTimestamp.Format(time.RFC1123)),
					resource.TestCheckResourceAttr(resourceName, "rfc1123z", offsetTimestamp.Format(time.RFC1123Z)),
					...
					resource.TestCheckResourceAttr(resourceName, "unixdate", offsetTimestamp.Format(time.UnixDate)),
